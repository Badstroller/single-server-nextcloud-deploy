...
read -p "Enter IP address or hostname (leave blank to auto-detect - if you're running on wsl you will need to manually enter your host machine's IP): " input_ip4
if [ -z "$input_ip4" ]; then
